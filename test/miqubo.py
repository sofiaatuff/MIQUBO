...
def mutual_information_bqm(dataset, features, target):
    """Build a BQM that maximizes MI between sharpe ratio and a subset of features"""
...
def run_demo(dataset, target):
    ...
    # Rank the MI between sharpe ratio and every other variable
    ...
    # Plot the MI between sharpe ratio and every other variable
    plt.figure()
    ax1 = plt.subplot(1, 2, 1)
    ax1.set_title("Mutual Information")
    ax1.set_ylabel('MI Between Sharpe_Ratio and Feature')
    ...
    dataset = dataset[[column[0] for column in sorted_scores[0:keep]] + ['Sharpe_Ratio']]
...
if __name__ == "__main__":
    ...
    plots_path = os.path.join(demo_path, "plots6.png")
